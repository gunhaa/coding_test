...
0.5 초 (추가 시간 없음)	128 MB	119825	68672	58080	58.043%
문제
...
1 ≤ k, n ≤ 14
    */
    ...
    public static void main(String[] args) throws IOException {
        System.setIn(new FileInputStream("src/main/java/baekjoon/bronze/_2775/input"));
